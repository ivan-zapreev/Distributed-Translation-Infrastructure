...
#die;
print STDERR "$mert $mert_work_dir $src_file $ref_stem $nbest_size $decoder_wrapper \"$decoder_parameters\" \"$lambdas\"$lexfeat_arg$no_parallel_argument$pro_parallel_arg$restart_iter\n";
system("$mert $mert_work_dir $src_file $ref_stem $nbest_size $decoder_wrapper \"$decoder_parameters\" \"$lambdas\"$lexfeat_arg$no_parallel_argument$pro_parallel_arg$restart_iter");
