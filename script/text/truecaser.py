#coding:utf-8
# Originator: Nils Reimers
# Adapted by: Dr. Ivan S. Zapreev
# Purpose: 
#   Allows to true case sentence tokens for any language.
#   The models are to be generated by the software provided
#   in the repository specified below. The default english
#   model is to be downloaded from the Release section
#   https://github.com/nreimers/truecaser/releases
