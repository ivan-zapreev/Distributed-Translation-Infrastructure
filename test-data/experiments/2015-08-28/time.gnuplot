...
plot "<paste  model_size.dat kenlm_time.dat" using 4:6 ls 1 title "KenLM" with lines,\
  "<paste model_size.dat srilm_time.dat" using 4:6 ls 2 title "SRILM" with lines ,\
  "<paste model_size.dat owl_w2ca_time.dat" using 4:6 ls 3 title "w2ca" with lines,\
  "<paste model_size.dat owl_c2wa_time.dat" using 4:6 ls 4 title "c2wa" with lines,\
  "<paste model_size.dat owl_cmhm_time.dat" using 4:6 ls 5 title "cmhm" with lines,\
  "<paste model_size.dat owl_w2ch_time.dat" using 4:6 ls 6 title "w2ch" with lines,
set output
