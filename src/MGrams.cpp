    ...
    namespace smt {
        namespace tries {
            namespace mgrams {
                 ...
                 */
                typedef void(*create_x_gram_id)(const TShortId * word_ids, Comp_M_Gram_Id::T_Id_Storage_Ptr & m_p_gram_id);
                ...
                void Comp_M_Gram_Id::create_m_gram_id(const TShortId * word_ids,
                    ...
                    create_x_gram_funcs[num_word_ids](&word_ids[begin_idx], m_p_gram_id.value);
                }
#define IS_LESS -1
#define IS_EQUAL 0
#define IS_LARGER +1
                ...
                template<TModelLevel M_GRAM_LEVEL>
                int8_t Comp_M_Gram_Id::compare(const Comp_M_Gram_Id & one, const Comp_M_Gram_Id & two) {
                    const T_Id_Storage_Ptr & m_p_gram_id_one = one.value;
                 ...
                 */
                typedef bool(* is_compare_grams_id_func)(const Comp_M_Gram_Id &, const Comp_M_Gram_Id &);
