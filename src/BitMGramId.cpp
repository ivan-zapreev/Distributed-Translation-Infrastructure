            ...
            namespace mgrams {
                namespace __Bit_M_Gram_Id {
                    ...
                    inline void create_2_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_2], M_GRAM_LEVEL_2 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_3_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_3], M_GRAM_LEVEL_3 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_4_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_4], M_GRAM_LEVEL_4 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_5_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_5], M_GRAM_LEVEL_5 >
                                (word_ids, m_p_gram_id);
                    }
