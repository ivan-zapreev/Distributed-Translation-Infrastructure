    ...
    namespace smt {
        namespace tries {
            namespace mgrams {
                namespace __Bit_M_Gram_Id {
                    ...
                    inline void gram_id_type_2_bit_len(uint32_t id_type, uint8_t & id_len_bits) {
                        ...
                        for (int idx = (M_GRAM_LEVEL - 1); idx >= 0; --idx) {
                            ...
                            LOG_USAGE << SSTR(id_type) << " / " << SSTR(gram_id_type_mult[idx]) << " =  " << SSTR((uint32_t) coeff) << END_LOG;
                    ...
                    static inline void create_gram_id(const TShortId * word_ids,
                        ...
                        LOG_USAGE << "Creating the " << SSTR(M_GRAM_LEVEL) << "-gram id with "
                        ...
                        for (size_t idx = 0; idx < M_GRAM_LEVEL; ++idx) {
                            ...
                            LOG_USAGE << "Word id: " << SSTR(word_ids[idx])
                        ...
                        if (m_p_gram_id == NULL) {
                            ...
                            LOG_USAGE << "Created a Bit_M_Gram_Id: " << SSTR((void *) m_p_gram_id) << END_LOG;
                        }
                        //Clean the memory
                        ...
                        LOG_USAGE << "ID_TYPE_LEN_BITS: " << (uint32_t) ID_TYPE_LEN_BITS << ", id_type_value: " << id_type_value << END_LOG;
                        ...
                        LOG_USAGE << "Finished making the " << SSTR(M_GRAM_LEVEL) << "-gram id with "
                    ...
                    inline void create_2_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < __Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_2], M_GRAM_LEVEL_2 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_3_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < __Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_3], M_GRAM_LEVEL_3 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_4_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < __Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_4], M_GRAM_LEVEL_4 >
                                (word_ids, m_p_gram_id);
                    }

                    inline void create_5_gram_id(const TShortId * word_ids,
                            T_Gram_Id_Storage_Ptr & m_p_gram_id) {
                        create_gram_id < __Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL_5], M_GRAM_LEVEL_5 >
                                (word_ids, m_p_gram_id);
                    }
                ...
                void Bit_M_Gram_Id::create_m_gram_id(const TShortId * word_ids,
...
#define IS_LARGER +1
                ...
                int Bit_M_Gram_Id::compare(const T_Gram_Id_Storage_Ptr & m_p_gram_id_one, const T_Gram_Id_Storage_Ptr & m_p_gram_id_two) {
                    ...
                    constexpr uint8_t ID_TYPE_LEN_BITS = __Bit_M_Gram_Id::M_GRAM_ID_TYPE_LEN_BITS[M_GRAM_LEVEL];
                    ...
                    LOG_USAGE << "M_GRAM_LEVEL: " << (uint32_t) M_GRAM_LEVEL << ", type_one: " << type_one << ", type_two: " << type_two << END_LOG;
                    ...
                    if (type_one < type_two) {
                        ...
                        if (type_one > type_two) {
                            ...
                            __Bit_M_Gram_Id::get_gram_id_len < ID_TYPE_LEN_BITS, M_GRAM_LEVEL > (m_p_gram_id_one, id_len_bytes);
                            ...
                            LOG_USAGE << (void*) m_p_gram_id_one << " = " << bytes_to_bit_string(m_p_gram_id_one, id_len_bytes) << END_LOG;
                            LOG_USAGE << (void*) m_p_gram_id_two << " = " << bytes_to_bit_string(m_p_gram_id_two, id_len_bytes) << END_LOG;
                ...
                template int Bit_M_Gram_Id::compare<M_GRAM_LEVEL_2>(const T_Gram_Id_Storage_Ptr & m_p_gram_id_one, const T_Gram_Id_Storage_Ptr & m_p_gram_id_two);
                template int Bit_M_Gram_Id::compare<M_GRAM_LEVEL_3>(const T_Gram_Id_Storage_Ptr & m_p_gram_id_one, const T_Gram_Id_Storage_Ptr & m_p_gram_id_two);
                template int Bit_M_Gram_Id::compare<M_GRAM_LEVEL_4>(const T_Gram_Id_Storage_Ptr & m_p_gram_id_one, const T_Gram_Id_Storage_Ptr & m_p_gram_id_two);
                template int Bit_M_Gram_Id::compare<M_GRAM_LEVEL_5>(const T_Gram_Id_Storage_Ptr & m_p_gram_id_one, const T_Gram_Id_Storage_Ptr & m_p_gram_id_two);

                bool Bit_M_Gram_Id::is_equal_m_grams_id(const T_Gram_Id_Storage_Ptr & one, const T_Gram_Id_Storage_Ptr & two, const TModelLevel level) {
                    return __Bit_M_Gram_Id::is_equal_x_grams_id_funcs[level](one, two);
                }

                bool Bit_M_Gram_Id::is_less_m_grams_id(const T_Gram_Id_Storage_Ptr & one, const T_Gram_Id_Storage_Ptr & two, const TModelLevel level) {
                    return __Bit_M_Gram_Id::is_less_x_grams_id_funcs[level](one, two);
                }

                bool Bit_M_Gram_Id::is_more_m_grams_id(const T_Gram_Id_Storage_Ptr & one, const T_Gram_Id_Storage_Ptr & two, const TModelLevel level) {
                    return __Bit_M_Gram_Id::is_more_x_grams_id_funcs[level](one, two);
                }
