...
namespace uva {
    namespace smt {
        namespace tries {
            ...
            class W2CArrayTrie : public LayeredTrieBase<MAX_LEVEL, WordIndexType, __W2CArrayTrie::DO_BITMAP_HASH_CACHE> {
            public:
                typedef LayeredTrieBase<MAX_LEVEL, WordIndexType, __W2CArrayTrie::DO_BITMAP_HASH_CACHE> BASE;
