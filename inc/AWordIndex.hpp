    ...
    namespace smt {
        namespace tries {
            namespace dictionary {
                 ...
                 */
                template<typename TIssuedIdType>
                class AWordIndex {
                public:
                    //The issued id type
                    typedef TIssuedIdType TWordIdType;
                     ...
                     */
                    inline TIssuedIdType get_word_id(const TextPieceReader & token) const {
                        THROW_MUST_OVERRIDE();
                    };
                     ...
                     */
                    inline TIssuedIdType register_word(const TextPieceReader & token) {
                        THROW_MUST_OVERRIDE();
                    };
