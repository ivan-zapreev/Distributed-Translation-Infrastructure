...
#ifndef GENERIC_CLIENT_BASE_HPP
#define GENERIC_CLIENT_BASE_HPP
    ...
    namespace smt {
        namespace bpbd {
            namespace client {
                ...
                class generic_client_base : public generic_client {
                protected:
                ...
                public:
                    ...
                    m_notify_conn_open(notify_conn_open), m_uri(uri) {
                        ...
                        m_client.set_open_handler(bind(&generic_client_base::on_open, this, _1));
                        m_client.set_close_handler(bind(&generic_client_base::on_close, this, _1));
                        m_client.set_fail_handler(bind(&generic_client_base::on_fail, this, _1));
                        m_client.set_message_handler(bind(&generic_client_base::on_message, this, _1, _2));
                    }

                    /**
                     * The basic destructor that also stops the client
                     */
                    virtual ~generic_client_base() {
                        //Stope the client
                        disconnect();
                    }
