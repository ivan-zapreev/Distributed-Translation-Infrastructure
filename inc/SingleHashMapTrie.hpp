    ...
    namespace smt {
        namespace tries {
            ...
            public:
                 ...
                 */
                explicit SingleHashMapTrie(const float wordIndexMemFactor);
            ...
            private:
                 ...
                 */
                SingleHashMapTrie(const SingleHashMapTrie& orig) : AHashMapTrie<N>(0.0) {
                    throw Exception("SingleHashMapTrie copy constructor is not to be used, unless implemented!");
                };
