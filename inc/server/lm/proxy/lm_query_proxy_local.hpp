...
#ifndef TRIE_QUERY_PROXY_IMPL_HPP
            ...
            namespace server {
                namespace lm {
                    namespace proxy {
                        ...
                        class lm_query_proxy_local : public lm_query_proxy {
                        public:
                             ...
                             */
                            lm_query_proxy_local(const trie_type & trie) : m_query(trie) {
                            }
                            
                            /**
                             * @see lm_query_proxy
                             */
                            virtual ~lm_query_proxy_local(){
